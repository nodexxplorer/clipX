...
const styles = StyleSheet.create({
    ...
    freeBanner: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, backgroundColor: 'rgba(8,145,178,0.08)', borderWidth: 1, borderColor: 'rgba(8,145,178,0.15)', borderRadius: radius.md, padding: spacing.md, marginBottom: spacing.xxl, marginTop: spacing.sm },
